  ...
  return (
    <header className="bg-white border-b border-tfs-gray px-6 py-3 flex items-center justify-between flex-shrink-0">
      <div>
        ...
        <p className="text-xs text-gray-400 mt-0.5">ICF Assistant Value Framework — Thermo Fisher Scientific</p>
      </div>
      <div className="flex items-center gap-3">
        ...
        <span className="inline-flex items-center px-2.5 py-1 rounded-full bg-red-50 border border-red-200 text-xs font-medium text-primary">
          Live
        </span>
      </div>
    </header>
